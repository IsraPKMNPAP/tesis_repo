"""
Baseline multimodal (tabular + CLIP + EEG) con fusión temprana.
...
def main() -> None:
    ...
    y_true_tr, y_prob_tr = evaluate(model, train_loader, device, mode=args.mode, use_tab=args.use_tabular, use_clip=args.use_clip, use_eeg=args.use_eeg)
    y_true_val, y_prob_val = evaluate(model, val_loader, device, mode=args.mode, use_tab=args.use_tabular, use_clip=args.use_clip, use_eeg=args.use_eeg)
    y_true_te, y_prob_te = evaluate(model, test_loader, device, mode=args.mode, use_tab=args.use_tabular, use_clip=args.use_clip, use_eeg=args.use_eeg)
