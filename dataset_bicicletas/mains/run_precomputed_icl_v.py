...
def main():
    ...
    ap.add_argument("--vid-emb-col", type=str, default="clip_emb_path", help="Columna con embedding de video precalculado (.pt/.npy)")
    ap.add_argument("--aud-emb-col", type=str, default="wav2vec_emb_path", help="Columna con embedding de audio precalculado (.pt/.npy)")
    ap.add_argument("--vid-emb-dim", type=int, default=1024)
    ap.add_argument("--aud-emb-dim", type=int, default=768)
