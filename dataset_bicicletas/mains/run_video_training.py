...
def main():
    ...
    ap.add_argument("--grad-clip", type=float, default=None, help="Clip de norma de gradiente (ej. 1.0)")
    ap.add_argument("--label-smoothing", type=float, default=0.0, help="Label smoothing para CrossEntropy (0-1)")
